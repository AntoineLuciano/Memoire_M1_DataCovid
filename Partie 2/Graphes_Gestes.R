...
# Figure 1 : Fréquence de respect des gestes barrières au cours des 8 vagues confondues
View(t(table_full_data))

# Figure 2 : Évolution du port du masque au fil du temps
...
legend(3.2, 40, legend=c("Tout le temps", "N'a pas la possibilité"),
       col=c("blue", "red"), lty=1, cex=0.8)

# Figure 2 : Évolution de l'utilisation de gel hydroalcoolique au fil du temps
